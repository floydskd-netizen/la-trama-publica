...
form.addEventListener('submit',async e=>{e.preventDefault();if(!cfg.supabaseUrl||!cfg.supabaseAnonKey){msg.textContent=isEn?'Submission service is unavailable.':'El servicio de aportes no est? disponible.';return}
